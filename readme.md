...
The @h2ml/bettertimeout library provides 2 simple classes for working with the native <code>window.setTimeout()</code> method in a more modern, robust, manner. 

## Quick Start Guide

### The [Timeout](#module_@h2ml/bettertimeout..Timeout) Class
...
### The [Timer](#module_@h2ml/bettertimeout..Timer) Class

The <code>Timer</code> class is the more robust of the two interfaces. After being invoked with <code>new</code> and provided with a <code>config</code> object, the <code>Timer</code> instance can be used (and re-used) as a <code>Promise</code> based alternative to both the <code>Timeout</code> class and the <code>window.setTimeout()</code> method. 
